...
- 启动或继续本 skill 的正式任务前，必须运行：
  ```bash
  python .agents/skills/paper-workflow-orchestrator/scripts/workflow_guard.py --skill model-code-and-result-generator
  ```
...
```bash
python .agents/skills/model-code-and-result-generator/scripts/build_result_contracts.py
```
