...
def main() -> int:
    ...
    print("=== Step-0 输出目录规划 ===")
    layout_script = root / ".agents/skills/paper-workflow-orchestrator/scripts/prepare_output_layout.py"
    ...
    analyzer_script = root / ".agents/skills/problem-doc-model-selector/scripts/analyze_problem.py"
    ...
    model_route_script = root / ".agents/skills/modeling-paper-rubric-and-model-selector/scripts/build_model_route.py"
    ...
    harvester_script = root / ".agents/skills/authoritative-data-harvester/scripts/run.py"
    ...
    r_clean = run_step(
        [sys.executable, ".agents/skills/data-cleaning-and-visualization/scripts/run_pipeline.py"],
        check=False,
    )
    ...
    result_contract_script = root / ".agents/skills/model-code-and-result-generator/scripts/build_result_contracts.py"
    ...
    r0 = run_step(
        [sys.executable, ".agents/skills/quality-assurance-auditor/scripts/pipeline.py"],
        check=False,
    )
    if r0.returncode != 0:
    ...
    r1 = run_step(
        [
            sys.executable,
            ".agents/skills/paper-micro-unit-generator/scripts/generate_all_offline.py",
            "--output-root",
    ...
    r2 = run_step(
        [
            sys.executable,
            ".agents/skills/paper-micro-unit-generator/scripts/merge.py",
            "--output-root",
            "paper_output/quickstart",
            "--stem",
            "quickstart_scaffold",
