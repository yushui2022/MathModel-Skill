...
```bash
python .agents/skills/mathmodel-flash/scripts/flash_preflight.py
python .agents/skills/mathmodel-flash/scripts/flash_run.py
python .agents/skills/mathmodel-flash/scripts/flash_finalize.py
```
