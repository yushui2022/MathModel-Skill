...
PREFLIGHT_COMMAND = "python skills/paper-workflow-orchestrator/scripts/preflight_check.py"
QUICKSTART_COMMAND = "python skills/paper-workflow-orchestrator/scripts/quickstart_run.py"
...
def main() -> int:
    ...
    print()
    print("正式赛题请按以下顺序：")
    print("  1) 让 Agent 读取 skills/paper-workflow-orchestrator/SKILL.md")
    print("  2) 第一步先运行预检：")
