...
```bash
python .trae/skills/mathmodel-lite/scripts/lite_preflight.py
```
...
```bash
python .trae/skills/mathmodel-lite/scripts/lite_run.py
```
...
```bash
python .trae/skills/mathmodel-lite/scripts/lite_finalize.py
```
