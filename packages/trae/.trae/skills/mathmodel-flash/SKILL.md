...
```bash
python .trae/skills/mathmodel-flash/scripts/flash_preflight.py
python .trae/skills/mathmodel-flash/scripts/flash_run.py
python .trae/skills/mathmodel-flash/scripts/flash_finalize.py
```
